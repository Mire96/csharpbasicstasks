...
namespace ChessProblem
{
    public class Rook : Figure
    {
        ...
        public Rook(Field field, char mark, Color color) : base(color, field, mark)
        {
            //Field = field;
            //Color = color;
        ...
        public override bool MoveCheck(Field f1) => this.Field.CheckSameColumn(f1) || this.Field.CheckSameRow(f1);
